...
def load_blocks():
    """Plugin entry point — ships roboflow_core/openai_compatible@v1 for
    container deployments where the base inference image is older than the
    block's release date."""
    return [OpenAICompatibleBlockV1]
